                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body" style="background-color:#08827F; border-color:#08827F">
                            <h5 style="color:#ffffff">Enter Cashier Details</h5>
                        </div>
                        <div class="card-body">
                            <form class="from-group" action="func.php" method="post">
                                <label style="color:#08827F">Cashier Name</label>
                                <input type="text" name="caname" class="form-control"><br>
                                ...
                                <input type="submit" class="btn btn-primary" name="cashier_submit" value="Submit">
                            </form>
                        </div>
                    </div>
                </div>
