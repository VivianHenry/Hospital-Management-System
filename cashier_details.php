                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body" style="background-color:#08827F; border-color:#08827F">
                            <div class="row">
                                <div class="col-md-4">
                                    <h5 style="color:#ffffff">Cashier Details</h5>
                                </div>
                                <div class="col-md-7">
                                    <form class="form-group" action="cashier_search.php" method="post">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="text" name="search_cashier" placeholder="Enter name" class="form-control">
                                            </div>
                                            <div class="col-md-2">
                                                <input type="submit" name="search_cashier_button" value="Search" class="btn btn-primary"> 
                                            </div>
                                        </div>
                                    </form>
                                </div>
