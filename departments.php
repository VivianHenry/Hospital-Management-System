                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body" style="background-color:#08827F; border-color:#08827F">
                            <div class="row">
                                <div class="col-md-4">
                                    <h5 style="color:#ffffff">Departments</h5>
                                </div>
                                <div class="col-md-7">
                                    <form class="form-group" action="department_search.php" method="post">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="text" name="search" placeholder="Enter department name" class="form-control">
                                            </div>
                                            <div class="col-md-2">
